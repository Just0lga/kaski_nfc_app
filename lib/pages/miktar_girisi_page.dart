...
class MiktarGirisiPage extends StatefulWidget {
  const MiktarGirisiPage({super.key});

  @override
  State<MiktarGirisiPage> createState() => _OdemePageState();
}

class _OdemePageState extends State<MiktarGirisiPage> {
        ...
        return AlertDialog(
          ...
          content: TextField(
            ...
            decoration: InputDecoration(
              ...
              labelStyle: TextStyle(color: Color.fromRGBO(96, 190, 244, 1.0)),
              suffixText: "ton",
              suffixStyle: TextStyle(color: Color.fromRGBO(96, 190, 244, 1.0)),
            ),
            autofocus: true,
          ),
          actions: [
                    ...
                    buttonOnTap: () {
                      if (tutar > 0) {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => const KartBilgileriPage(),
                          ),
                        );
                        ScaffoldMessenger.of(context).showSnackBar(
                          SnackBar(
